...
import com.radicalplay.nfm2.teavm.WebGraphics2D;

import emul_java.awt.geom.Rectangle2D;
import emul_java.text.CharacterIterator;
...
//    }
    ...
    public int stringWidth(String str) {
        TextMetrics textMetrics = getTextMetricsEx(str, null);
        return (int) textMetrics.getWidth();
    }
...
//    }
    ...
    public Rectangle2D getStringBounds( String str, Graphics context) {
        TextMetrics textMetrics = getTextMetricsEx(str, context);
        Rectangle2D result = new Rectangle2D.Double(
                0,
                0,
                textMetrics.getWidth(),
                textMetrics.getActualBoundingBoxAscent()
        );
    ...
    private TextMetrics getTextMetricsEx(String str, Graphics context) {
        ...
        TextMetrics textMetrics = (TextMetrics) ((WebGraphics2D) context).context.measureText(str);
